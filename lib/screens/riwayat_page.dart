...
class _RiwayatPageState extends State<RiwayatPage> {
  int _selectedTab = 0; // 0: Riwayat Saya, 1: Semua Riwayat
  String _myNim = '';
  ...
  Future<void> _loadUserNim() async {
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _selectedTab == 0 ? AppColors.inkNavy : Colors.transparent,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Text(
                            'Riwayat Saya',
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: Container(
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
                            color: _selectedTab == 1 ? AppColors.inkNavy : Colors.transparent,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Text(
                            'Semua Riwayat',
            ...
            Expanded(
              child: BlocBuilder<RiwayatCubit, RiwayatState>(
                builder: (context, state) {
                  ...
                  final allList = (state as RiwayatLoaded).data;
                  final list = _selectedTab == 0
                      ? allList.where((p) => p.nim == _myNim).toList()
                      : allList;
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _selectedTab == 0
                                ? 'Belum ada riwayat kehadiran Anda'
                                : 'Belum ada riwayat kehadiran kelompok',
                            style: const TextStyle(
                              color: AppColors.inkNavy,
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                          ...
                          Text(
                            _selectedTab == 0
                                ...
                                : 'Seluruh data presensi dari Supabase kosong.',
                            style: const TextStyle(
